...
<div id="container" >
    <div id="header">
        ...
        <nav  style="text-align:center;margin-left:20px;margin-bottom:20px;padding:5px;" >
        ...
        @if(Auth::check())
            ...
            <a style="color:white;" href="{{ route('register') }}">s'inscrire</a>
        ...
        @endif
            ...
            <div>
            <ul id="nav" class="radius menu megamenu" style="margin-top: 55px;margin-bottom: 50px;">
...
<h1 style="direction:rtl;text-align:right;color: #6387B1;">مؤسسات :</h1>                                                        <!-- Main content here -->
                                                    </div><hr><br>
                                                        <ul style="list-style: none; padding: 0;direction: rtl; text-align: right; list-style-position: inside;">
                                                            ...
                                                            <li style="margin-bottom: 10px;" id="R06">
                                                                <a style="font-size: 16px; color: #6387B1; text-decoration: none;" id="R06_1"  href="{{ route('ecoleprimaire') }}">
                                                                    <span style="color: #ff6215;">»</span><strong> مدرسة ابتدائية مستقلة (Ecole primaire autonome)</strong>
                                                                </a>
                                                            </li><hr><br>
                                                            <li style="margin-bottom: 10px;" id="R04">
                                                                <a style="font-size: 16px; color: #6387B1; text-decoration: none;" id="R04_1"  href="{{ route('ecoledélégationprovincial') }}">
                                                                    <span style="color: #ff6215;">»</span><strong>النيابة الإقليمية لوزارة التربية الوطنية (Délégation Provinciale  du MEN)</strong> 
                                                                </a>
                                                            </li><hr><br>
                                                            <li style="margin-bottom: 10px;" id="R02">
                                                                <a style="font-size: 16px; color: #6387B1; text-decoration: none;" id="R02_1"  href="{{ route('ecolelyceecollegial') }}">
                                                                    <span style="color: #ff6215;">»</span><strong>الثانوية الإعدادية للتعليم العام (Lycée collègial enseignement général)</strong> 
                                                                </a>
                                                            </li><hr><br>
                                                            <li style="margin-bottom: 10px;" id="R07">
                                                                <a style="font-size: 16px; color: #6387B1; text-decoration: none;" id="R07_1" href="{{ route('ecolelyceequalifiantenseignement') }}">
                                                                    <span style="color: #ff6215;">»</span><strong>الثانوية الثأهيلية للتعليم العام (Lycée qualifiant enseignement général)</strong> 
                                                                </a>
                                                            </li><hr><br>
                                                            <li style="margin-bottom: 10px;" id="R03">
                                                                <a style="font-size: 16px; color: #6387B1; text-decoration: none;" id="R03_1"  href="{{ route('ecoleacademieregionale') }}">
                                                                    <span style="color: #ff6215;">»</span><strong> الأكاديمية الجهوية للتربية والتكوين (Académie Régionale de l'Education)</strong>
                                                                </a>
                                                            </li><hr><br>
                                                            <li style="margin-bottom: 10px;" id="R05">
                                                                <a style="font-size: 16px; color: #6387B1; text-decoration: none;" id="R05_1"  href="{{ route('ecoleacademieregionale') }}">
                                                                    <span style="color: #ff6215;">»</span><strong>الثانوية الثأهيلية المرجعية (Lycée qualifiant de référence)</strong> 
                                                                </a>
                                                            </li><hr><br>
                                                            <li style="margin-bottom: 10px;" id="R01">
                                                                <a style="font-size: 16px; color: #6387B1; text-decoration: none;" id="R01_1" href="{{ route('ecolecentreregional') }}">
                                                                    <span style="color: #ff6215;">»</span> <strong>المركز الجهوي لمهن التربية والتكوين (Centre Régional des Métiers de l'Education)</strong> 
                                                                </a>
                                                            </li>
                                                        </ul>
