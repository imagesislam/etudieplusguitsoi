                            ...
                            function ZoomPlus() {
                                ...
                                <div class="mainbloc popoverWrap" id="mainbloc">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8" style="border-radius: 20px;margin-top:20px;"> <!-- 7/12 corresponds approximately to 60% -->
                                            
                                            <div class="card mb-3" >
                                            @foreach($posts as $post)
                                            @if($post->image)
                                                <img style="width:100%;padding-top: 30px;padding-left: 20px;padding-right: 20px;" src="{{ asset('storage/'.$post->image) }}"  class="card-img-top" alt="...">
                                                @endif
                                                <div class="card-body">
                                                <a href="">
                                                            <p style="color: #f46e27;direction: rtl; text-align: right; list-style-position: inside;"><strong>{{ $post->title }}</strong> </p>
                                                            <p style=" color: #4d6886;direction: rtl; text-align: right; list-style-position: inside;">{{ $post->content }}</p>                                
                                                </a>
            ...
            <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                <div class="d-flex justify-content-center">
                    @foreach ($chunk as $post)
                        <div class="card text-center mb-3" style="width: 18rem; margin: 0 10px;">
                            <div class="card-body">
                                @if ($post->image)
                                    <img src="{{ asset('storage/' . $post->image) }}" alt="Image de la publication" style="width: 100%; height: 150px; object-fit: cover;">
                                @endif
